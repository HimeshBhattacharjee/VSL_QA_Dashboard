...
from .mapping_helpers import apply_line_i_mapping_overrides

TEMPLATE_FILENAME = "Blank Audit Line-I.xlsx"
...
def get_observation_mapping() -> dict:
    return apply_line_i_mapping_overrides(deepcopy(OBSERVATION_CELL_MAPPING))
