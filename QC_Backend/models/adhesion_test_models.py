...
class AdhesionTestReport:
    def __init__(self, name: str, timestamp: str, s3_key: str, _id: Optional[str] = None):
        """
        Initialize AdhesionTestReport with S3 storage
    ...
    def get_data(self) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"Error retrieving adhesion test data from S3 (key: {self.s3_key}): {str(e)}")
            import traceback
            traceback.print_exc()
    ...
    def save_data(self, form_data: Dict[str, Any], averages: Dict[str, str]) -> bool:
        ...
        try:
            ...
            print(f"Error saving adhesion test data to S3 (key: {self.s3_key}): {str(e)}")
            import traceback
            traceback.print_exc()
            return False
    ...
    def delete_data(self) -> bool:
        ...
        try:
            ...
            print(f"Error deleting adhesion test data from S3 (key: {self.s3_key}): {str(e)}")
            import traceback
            traceback.print_exc()
            return False
