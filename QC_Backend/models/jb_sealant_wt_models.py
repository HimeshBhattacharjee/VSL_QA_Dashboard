...
try:
    jb_sealant_entries_collection.drop_index("date_1_shift_1")
except Exception:
    pass
jb_sealant_entries_collection.create_index([("date", ASCENDING), ("lineGroup", ASCENDING), ("shift", ASCENDING)], unique=True)
