        ...
        for entry in entries:
            ...
            if shift in shift_stats:
                ...
                if line1.get("netSealantWeight"):
                    ...
                    try:
                        weight = float(line1["netSealantWeight"])
                        if 4 <= weight <= 8:
                            pass_count += 1
                ...
                if line2.get("netSealantWeight"):
                    ...
                    try:
                        weight = float(line2["netSealantWeight"])
                        if 4 <= weight <= 8:
                            pass_count += 1
                            shift_stats[shift]["pass"] += 1
                        else:
    ...
    try:
        ...
        if not success:
            ...
            placeholder_entry = {
                ...
                "lines": {
                    "1": {"po": "", "jbSupplier": "", "sealantSupplier": "", "sealantExpiry": "", "jbWeight": "", "jbWeightWithSealant": "", "netSealantWeight": "", "totalModuleWeight": "", "remarks": ""},
                    "2": {"po": "", "jbSupplier": "", "sealantSupplier": "", "sealantExpiry": "", "jbWeight": "", "jbWeightWithSealant": "", "netSealantWeight": "", "totalModuleWeight": "", "remarks": ""}
                },
