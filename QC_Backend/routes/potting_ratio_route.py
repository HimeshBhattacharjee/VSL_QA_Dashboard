...
async def create_entry(entry: dict):
    ...
    try:
        ...
        date_signatures = PottingDailyEntry.get_context_signatures(entry["date"], entry.get("lineGroup"), entry["shift"])
        ...
        # Get the saved entry
        saved_entry = PottingDailyEntry.get_by_date_and_shift(entry["date"], entry["shift"], entry.get("lineGroup"))
