...
const InputComponents = {
    Select: ({ value, onChange, options, className = "", type = "status" }: {
        ...
        <select
            ...
            className={`w-full px-2 py-1 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary ${getBackgroundColor(value, type)} ${className}`}
        >
